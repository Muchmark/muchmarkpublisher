        ...
        <div className="App">
            <nav class="maindropdown">
                <ul className="flex flex-col sm:flex-row border-2 border-green-500 items-center content-center justify-center w-full">
                    ...
                    <li className="w-full sm:1/7">
                        <Link to="/blogs/trends"> Trends</Link>
                        <ul className="w-full sm:w-48">
                            <li>Trends</li>
                            <li>Hashtags</li>
                            <li>Marketing Ai</li>
            ...
            {/* <div className='grid grid-cols-1 sm:grid-cols-4 sm:gap-2 items-center justify-center content-center ml-4 sm:ml-2'>
                <Card />
                <Card />
                <Card />
                <Card />
